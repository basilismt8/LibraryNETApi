...
namespace Library.Api.Services
{
    ...
    {
        Task<ServiceResult<List<LoanDto>>> GetAllAsync(CancellationToken cancellationToken = default);
        Task<ServiceResult<LoanDto>> GetByIdAsync(Guid id, CancellationToken cancellationToken = default);
        Task<ServiceResult<List<LoanDto>>> GetByUserIdAsync(Guid userId, CancellationToken cancellationToken = default);
